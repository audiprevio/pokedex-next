...
export default function LikedPokemonPage() {
    ...
    return (
      ...
      <div className='w-4/5'>
      <div className="bg-red-300 max-w-full py-10  h-[100dvh]  overflow-y-scroll container mx-auto items-center flex-col justify-center md:px-10 px-20">
        <div className='items-center flex justify-center flex-col pb-10'>
        <h1 className="text-3xl font-bold mb-4 flex items-center justify-center text-pokeBody font-3xl">Pokemons you've liked</h1>
          </div>
